...
$contact = $conn->real_escape_string($_POST['address']);

$password = $conn->real_escape_string($_POST['password']);
$options ="ENABLE";
$query = "INSERT into CUSTOMER(fullname,username,contact,address,password,options) VALUES('" . $fullname . "','" . $username . "','" . $contact . "','" . $password ."','" . $address . "','" . $options ."')";
