...
<div class="container">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="view_order_details1.php" method="POST">
        <br style="clear: both">
           <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> YOUR ORDER LIST HERE </h3>
...
$sql = "SELECT * FROM orders o WHERE o.S_ID IN (SELECT r.S_ID FROM SHOP r WHERE r.M_ID='$user_check') ORDER BY order_date";
