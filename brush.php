...
<body>
<div class="container">
  <form class="form-inline" method="post" action="search3.php">
    <input type="text" name="type" class="form-control" placeholder="Search Product">
    <button type="submit" name="save" class="btn btn-primary">Search</button>

</div>
<div class="container" style="width:95%;">

<!-- Display all Makeup from face table -->
<?php

require 'connection.php';
$conn = Connect();

$sql = "SELECT * FROM TOOLS WHERE options = 'ENABLE' ORDER BY type";
...
<input type="hidden" name="hidden_SID" value="<?php echo $row["S_ID"]; ?>">
...
else
{
  ...
  <div class="container">
    <div class="jumbotron">
      <center>
         <label style="margin-left: 5px;color: red;"> <h1>No Makeup is available.</h1> </label>
