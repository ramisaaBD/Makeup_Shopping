...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="edit_eye_items.php" class="list-group-item">Edit Eyes Items</a>
    		</div>
    </div>
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    $query = mysqli_query($conn, "UPDATE eyes set
    name='$name', price='$price',
    description='$description' where P_ID='$P_ID'");
    }
    $query = mysqli_query($conn, "SELECT * FROM eyes f WHERE f.S_ID IN (SELECT r.S_ID FROM SHOP r WHERE r.M_ID='$user_check') ORDER BY P_ID");
    while ($row = mysqli_fetch_array($query)) {
      ...
      <div class="list-group" style="text-align: center;">
        <?php
      echo "<b><a href='edit_eye_items.php?update= {$row['P_ID']}'>{$row['name']}</a></b>";  
        ?>
      </div>
    ...
    $update = $_GET['update'];
    $query1 = mysqli_query($conn, "SELECT * FROM eyes WHERE P_ID=$update");
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="edit_eye_items.php" method="GET">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> EDIT YOUR EYES ITEMS HERE </h3>
