...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="delete_makeup_items.php" class="list-group-item active">Delete Makeup Items</a>
                <a href="delete_face_items.php" class="list-group-item">Delete Face Item</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="delete_makeup_items1.php" method="POST">
        <br style="clear: both">
...
$sql = "SELECT * FROM face f WHERE f.options = 'ENABLE' AND f.S_ID IN (SELECT r.S_ID FROM SHOP r WHERE r.M_ID='$user_check') ORDER BY P_ID";
