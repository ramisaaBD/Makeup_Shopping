...
<a href="add_nail.php" class="list-group-item ">Add Nail Items</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="add_makeup_items5.php" method="POST">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> ADD NEW NAILS ITEM HERE </h3>
