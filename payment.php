...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (P_ID, productname, price,  quantity, order_date, username, S_ID) VALUES ('" . $P_ID . "','" . $productname . "','" . $price . "','" . $quantity . "','" . $order_date . "','" . $username . "','" . $S_ID . "')";
...
<h1 class="text-center">
  <a href="cart.php"><button class="btn btn-warning"><span class="glyphicon glyphicon-circle-arrow-left"></span> Go back to cart</button></a>
   <a href="COD.php"><button class="btn btn-success"><span class="glyphicon glyphicon-"></span>Confirm Order</button></a>
</h1>
